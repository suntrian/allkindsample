...
public class ChineseSearcher {
  ...
  public static void search(String indexDir, String q) throws ParseException, IOException, InvalidTokenOffsetsException {
    //得到读取索引文件的路径
...
//索引结束时间
    ...
    System.out.println("匹配"+ q +",总共花费了"+(end-start)+"毫秒,共查到"+topDocs.totalHits+"条记录。");
//高亮显示start
//算分
...
//输出全路径
  ...
  public static void main(String[] args) {
    //索引指定的路径
    String indexDir = "D:\\temp\\kingsoft log\\index_data2";
  //查询的字段
    String par = "南京";
    try {
      search(indexDir,par);
